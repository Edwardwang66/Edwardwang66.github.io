    ...
    selectedEvidence: [
      {
        ...
        alt: "IMU body orientation beside estimated and VICON roll, pitch, and yaw traces",
        caption:
          "PR1 · Quaternion orientation propagation from calibrated IMU angular velocity, compared against VICON.",
        width: 960,
        height: 540,
        role: "technical",
      },
      {
        ...
        alt: "Occupancy-grid construction with corrected LiDAR SLAM trajectory and robot pose",
        caption:
          "PR2 · Submap ICP trajectory correction while sampled LiDAR scans build the occupancy grid.",
        width: 960,
        height: 540,
        role: "technical",
      },
      {
        ...
        alt: "Visual-inertial SLAM trajectory, IMU-only comparison, and mapped landmarks",
        caption:
          "PR3 · Visual–inertial trajectory and mapped landmarks revealed against the IMU-only baseline.",
        width: 960,
        height: 540,
        role: "technical",
      },
